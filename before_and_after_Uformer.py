...
def main():
    ...
    print("SHUFFLE_PATIENTS_FLAG = False:")
    path_salvar_modelo = "./resultados/treino_nao_degradadas_shuffle_patients_FALSE/"
    train_test_full(
        device=device,
        epochs=12,
    ...
    print()
    print("SHUFFLE_PATIENTS_FLAG = True:")
    path_salvar_modelo = "./resultados/treino_nao_degradadas_shuffle_patients_FALSE/"
    train_test_full(
        device=device,
        epochs=12,
...
def train_test_full(
    ...
    test(model, test_gen, criterion, device, path_salvar_modelo)
